...
const covid19ImpactEstimator = (data) => {
  ...
  const sCasesForVentilatorsByRequestedTime = Math.trunc(0.2 * sInfectionsByRequestedTime);
  const sImpactCasesForVenBRT = Math.trunc(0.2 * sImpactInfectionsByRequestedTime);
